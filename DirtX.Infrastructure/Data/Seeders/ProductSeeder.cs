    ...
    public static class ProductSeeder
    {
        ...
        private static void SeedAllProducts(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product { Id = 31, BrandId = 2, TypeId = 2, Title = "Fork Product 5W", Price = 27.00m, Description = "Lightweight fork oil for smoother suspension stroke.", IsAvailable = true, StockQuantity = 8, Category = ProductCategory.Fork_and_Shock, ImageUrl = "https://i.ibb.co/W52svBD/Product-Bel-Ray-Fork-5-W.jpg" },
                new Product { Id = 32, BrandId = 9, TypeId = 2, Title = "Performance Line: Shock Product", Price = 29.99m, Description = "Performance Line Products Series is used by MXGP Factory teams.", IsAvailable = true, StockQuantity = 8, Category = ProductCategory.Fork_and_Shock, ImageUrl = "https://i.ibb.co/f1fW4j5/Product-Motorex-Shock-Product.jpg" },
