    ...
    public static class ProductSeeder
    {
        ...
        private static void SeedOils(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Oil>().HasData(
                new Oil { Id = 1, BrandId = 9, Title = "2T Cross Power", Price = 28.99m, Description = "Premium 2-stroke oil for motorcycle engines.", IsAvailable = true, StockQuantity = 30, Type = OilType.Stroke2, PackageSize = 1.0, ImageUrl = "https://i.ibb.co/Cm7S8dG/Oil-Cross-Power-2-T.jpg" },
                new Oil { Id = 2, BrandId = 10, Title = "300V 15W60 1L", Price = 34.99m, Description = "Ester Core Premium 4-stroke oil for motorcycle engines.", IsAvailable = true, StockQuantity = 12, Type = OilType.Stroke4, PackageSize = 1.0, ImageUrl = "https://i.ibb.co/9Nyc55B/Oil-Motul-300-V-1-L.jpg" },
                new Oil { Id = 3, BrandId = 10, Title = "300V 10W40 4L", Price = 114.99m, Description = "Ester Core Premium 4-stroke oil for motorcycle engines.", IsAvailable = true, StockQuantity = 3, Type = OilType.Stroke4, PackageSize = 4.0, ImageUrl = "https://i.ibb.co/3ywBxpQ/Oil-Motul-300-V-4-L.jpg" },
        ...
        private static void SeedGears(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Gear>().HasData(
                ...
                new Gear { Id = 3, BrandId = 1, Title = "Bionic Action V2", Size = GearSize.L, Price = 319.99m, Description = "Durable protective vest for safe riding.", IsAvailable = true, StockQuantity = 4, Type = GearType.ProtectiveGear, ImageUrl = "https://i.ibb.co/RhPrZB3/Gear-Bionic-Action.jpg" },
                new Gear { Id = 4, BrandId = 15, Title = "AsteriX Knee Braces", Size = GearSize.M, Price = 179.99m, Description = "Knee protection that allows for some movement while protecting the knee cap and shin.", IsAvailable = true, StockQuantity = 10, Type = GearType.ProtectiveGear, ImageUrl = "https://i.ibb.co/JrJSf2y/Gear-Asterix-Knee.jpg" },
