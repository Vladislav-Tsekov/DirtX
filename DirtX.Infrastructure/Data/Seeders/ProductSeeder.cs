    ...
    public static class ProductSeeder
    {
        ...
        private static void SeedAllProducts(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product { Id = 3, BrandId = 7, TypeId = 1, Title = "Engine Clutch Cover", Price = 99.99m, Description = "Protective cover for motorcycle engines made of titanium.", StockQuantity = 4, Category = ProductCategory.Engine, ImageUrl = "https://i.ibb.co/1RXqkVy/Product-Engine-Cover.png" },
                ...
                new Product { Id = 19, BrandId = 8, TypeId = 1, Title = "Fork Seal Kit", Price = 44.99m, Description = "Seal kit for motorcycle forks to prevent leaks and maintain suspension performance.", StockQuantity = 18, Category = ProductCategory.Suspension, ImageUrl = "https://i.ibb.co/7jy1dvG/Product-Fork-Seals.jpg" },
                ...
                new Product { Id = 33, BrandId = 19, TypeId = 2, Title = "YAMALUBE 10W40", Price = 26.29m, Description = "The baseline 4-stroke engine oil for motorcycles.", StockQuantity = 14, Category = ProductCategory.Four_Stroke, ImageUrl = "https://i.ibb.co/2dRRzHy/Product-Yamalube-10w40.jpg" },
                ...
                // Riding Gear
                new Product { Id = 36, BrandId = 1, TypeId = 3, Title = "SM5", Price = 899.99m, Description = "Alpinestars' premium class lightweight motorcycle helmet for maximum protection.", StockQuantity = 2, Category = ProductCategory.Helmet, ImageUrl = "https://i.ibb.co/rs2c1Pd/Product-SM5-Helmet.jpg" },
                ...
                new Product { Id = 43, BrandId = 13, TypeId = 3, Title = "Blitz XR", Price = 559.99m, Description = "Motocross/Enduro boots with waterproof lining and reinforced toe.", StockQuantity = 6, Category = ProductCategory.Boots, ImageUrl = "https://i.ibb.co/34RRszr/Product-Blitz-Thor.jpg" },
                ...
                new Product { Id = 45, BrandId = 13, TypeId = 3, Title = "Element Gloves", Price = 39.99m, Description = "Universal offroad gloves.", StockQuantity = 11, Category = ProductCategory.Accessory, ImageUrl = "https://i.ibb.co/4Rf2r40/Product-Element-Gloves.jpg" }
            );
        }
    }
}