    ...
    public static class ProductSeeder
    {
        ...
        private static void SeedOils(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Oil>().HasData(
                new Oil { Id = 28, BrandId = 9, Title = "2T Cross Power", Price = 28.99m, Description = "Premium 2-stroke oil for motorcycle engines.", IsAvailable = true, StockQuantity = 30, Type = OilType.Two_Stroke, PackageSize = 1.0, ImageUrl = "https://i.ibb.co/Cm7S8dG/Oil-Cross-Power-2-T.jpg" },
                new Oil { Id = 29, BrandId = 10, Title = "300V 15W60 1L", Price = 34.99m, Description = "Ester Core Premium 4-stroke oil for motorcycle engines.", IsAvailable = true, StockQuantity = 12, Type = OilType.Four_Stroke, PackageSize = 1.0, ImageUrl = "https://i.ibb.co/9Nyc55B/Oil-Motul-300-V-1-L.jpg", Properties = new List<Specification> { new() { Id = 31 } } },
                new Oil { Id = 30, BrandId = 10, Title = "300V 10W40 4L", Price = 114.99m, Description = "Ester Core Premium 4-stroke oil for motorcycle engines.", IsAvailable = true, StockQuantity = 3, Type = OilType.Four_Stroke, PackageSize = 4.0, ImageUrl = "https://i.ibb.co/3ywBxpQ/Oil-Motul-300-V-4-L.jpg", Properties = new List<Specification> { new() { Id = 30 } } },
                new Oil { Id = 31, BrandId = 2, Title = "Fork Oil 5W", Price = 27.00m, Description = "Lightweight fork oil for smoother suspension stroke.", IsAvailable = true, StockQuantity = 8, Type = OilType.Suspension, PackageSize = 0.500, ImageUrl = "https://i.ibb.co/W52svBD/Oil-Bel-Ray-Fork-5-W.jpg", Properties = new List<Specification> { new() { Id = 29 } } },
                new Oil { Id = 32, BrandId = 9, Title = "Performance Line: Shock Oil", Price = 29.99m, Description = "Performance Line Oils Series is used by MXGP Factory teams.", IsAvailable = true, StockQuantity = 8, Type = OilType.Suspension, PackageSize = 0.750, ImageUrl = "https://i.ibb.co/f1fW4j5/Oil-Motorex-Shock-Oil.jpg" },
                new Oil { Id = 33, BrandId = 19, Title = "YAMALUBE 10W40", Price = 26.29m, Description = "The baseline 4-stroke engine oil for motorcycles.", IsAvailable = true, StockQuantity = 14, Type = OilType.Four_Stroke, PackageSize = 1.5, ImageUrl = "https://i.ibb.co/2dRRzHy/Oil-Yamalube-10w40.jpg", Properties = new List<Specification> { new() { Id = 30 } } },
                new Oil { Id = 34, BrandId = 10, Title = "AutoCool -35°C 1L", Price = 26.29m, Description = "The most efficient coolant on the market.", IsAvailable = true, StockQuantity = 14, Type = OilType.Coolant, PackageSize = 1.0, ImageUrl = "https://i.ibb.co/9rgYKcv/Oil-Motul-Antifreeze.jpg" },
                new Oil { Id = 35, BrandId = 10, Title = "TransOil Expert 10W40", Price = 28.29m, Description = "More throttle, less grinding gears.", IsAvailable = true, StockQuantity = 4, Type = OilType.Transmission, PackageSize = 1.0, ImageUrl = "https://i.ibb.co/zntBCFg/Oil-Transmission-Motul.jpg", Properties = new List<Specification> { new() { Id = 30 } } }
            );
        }
        ...
        private static void SeedGears(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Gear>().HasData(
                new Gear { Id = 36, BrandId = 1, Title = "SM5", Size = GearSize.M, Price = 899.99m, Description = "Alpinestars' premium class lightweight motorcycle helmet for maximum protection.", IsAvailable = true, StockQuantity = 2, Type = GearType.Helmet, ImageUrl = "https://i.ibb.co/rs2c1Pd/Gear-SM5-Helmet.jpg", Properties = new List<Specification> { new() { Id = 10 } } },
                new Gear { Id = 37, BrandId = 13, Title = "3-Series", Size = GearSize.S, Price = 279.99m, Description = "High-quality full-face racing helmet with aerodynamic design.", IsAvailable = true, StockQuantity = 7, Type = GearType.Helmet, ImageUrl = "https://i.ibb.co/YkHnz4F/Gear-3-Series-Oneal.jpg" },
                new Gear { Id = 38, BrandId = 1, Title = "Bionic Action V2", Size = GearSize.L, Price = 319.99m, Description = "Durable protective vest for safe riding.", IsAvailable = true, StockQuantity = 4, Type = GearType.Protective_Gear, ImageUrl = "https://i.ibb.co/RhPrZB3/Gear-Bionic-Action.jpg", Properties = new List<Specification> { new() { Id = 16 } } },
                new Gear { Id = 39, BrandId = 15, Title = "AsteriX Knee Braces", Size = GearSize.M, Price = 179.99m, Description = "Knee protection that allows for some movement while protecting the knee cap and shin.", IsAvailable = true, StockQuantity = 10, Type = GearType.Protective_Gear, ImageUrl = "https://i.ibb.co/JrJSf2y/Gear-Asterix-Knee.jpg", Properties = new List<Specification> { new() { Id = 16 } } },
                new Gear { Id = 40, BrandId = 13, Title = "50th Anniversary Jersey", Size = GearSize.L, Price = 79.99m, Description = "Limited anniversary edition jersey.", IsAvailable = true, StockQuantity = 3, Type = GearType.Outfit, ImageUrl = "https://i.ibb.co/bRsz5gz/Gear-Jersey-50th.jpg", Properties = new List<Specification> { new() { Id = 9 }, new() { Id = 10}, new() { Id = 15}, new() { Id = 32 } } },
                new Gear { Id = 41, BrandId = 15, Title = "Prime Ace Complete Outfit", Size = GearSize.M, Price = 259.99m, Description = "A complete outfit of THOR's middle-class 'Prime Ace' line.", IsAvailable = true, StockQuantity = 5, Type = GearType.Outfit, ImageUrl = "https://i.ibb.co/hcZKcsB/Gear-Thor-Outfit.jpg", Properties = new List<Specification> { new() { Id = 12 }, new() { Id = 15}, new() { Id = 32 } } },
                new Gear { Id = 42, BrandId = 1, Title = "Tech10", Size = GearSize.M, Price = 1099.99m, Description = "The most advanced riding boots on the market.", IsAvailable = true, StockQuantity = 2, Type = GearType.Boots, ImageUrl = "https://i.ibb.co/pzGDVTv/Gear-Tech10-Boots.jpg" },
                new Gear { Id = 43, BrandId = 13, Title = "Blitz XR", Size = GearSize.L, Price = 559.99m, Description = "Motocross/Enduro boots with waterproof lining and reinforced toe.", IsAvailable = true, StockQuantity = 6, Type = GearType.Boots, ImageUrl = "https://i.ibb.co/34RRszr/Gear-Blitz-Thor.jpg", Properties = new List<Specification> { new() { Id = 16 } } },
                new Gear { Id = 44, BrandId = 13, Title = "B20 Goggles", Size = GearSize.M, Price = 129.99m, Description = "Motocross goggles with flippers.", IsAvailable = true, StockQuantity = 6, Type = GearType.Accessory, ImageUrl = "https://i.ibb.co/sHzPG34/Gear-B20-Goggles.jpg", Properties = new List<Specification> { new() { Id = 12 } } },
                new Gear { Id = 45, BrandId = 13, Title = "Element Gloves", Size = GearSize.XL, Price = 39.99m, Description = "Universal offroad gloves.", IsAvailable = true, StockQuantity = 11, Type = GearType.Accessory, ImageUrl = "https://i.ibb.co/4Rf2r40/Gear-Element-Gloves.jpg", Properties = new List<Specification> { new() { Id = 10 } } }
            );
        }
    }
}