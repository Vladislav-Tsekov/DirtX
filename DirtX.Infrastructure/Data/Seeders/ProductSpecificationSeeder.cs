    ...
    public static class ProductSpecificationSeeder
    {
        public static void SeedProductsSpecifications(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ProductSpecification>().HasData(
                ...
                new ProductSpecification { ProductId = 28, SpecificationId = 34 },
                new ProductSpecification { ProductId = 29, SpecificationId = 31 },
                new ProductSpecification { ProductId = 29, SpecificationId = 34 },
                new ProductSpecification { ProductId = 30, SpecificationId = 30 },
                new ProductSpecification { ProductId = 30, SpecificationId = 35 },
                new ProductSpecification { ProductId = 31, SpecificationId = 29 },
                new ProductSpecification { ProductId = 31, SpecificationId = 34 },
                new ProductSpecification { ProductId = 32, SpecificationId = 37 },
                new ProductSpecification { ProductId = 33, SpecificationId = 30 },
                new ProductSpecification { ProductId = 33, SpecificationId = 34 },
                new ProductSpecification { ProductId = 34, SpecificationId = 34 },
                new ProductSpecification { ProductId = 35, SpecificationId = 30 },
                new ProductSpecification { ProductId = 35, SpecificationId = 34 },
                new ProductSpecification { ProductId = 36, SpecificationId = 10 },
                new ProductSpecification { ProductId = 36, SpecificationId = 39 },
                new ProductSpecification { ProductId = 37, SpecificationId = 40 },
                ...
                new ProductSpecification { ProductId = 40, SpecificationId = 38 },
                ...
                new ProductSpecification { ProductId = 41, SpecificationId = 39 },
                new ProductSpecification { ProductId = 42, SpecificationId = 41 },
                new ProductSpecification { ProductId = 43, SpecificationId = 16 },
                new ProductSpecification { ProductId = 43, SpecificationId = 42 },
